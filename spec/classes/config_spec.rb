...
rsa_cert_file=/etc/pki/simp_apps/vsftpd/pki/public/foo.example.com.pub
rsa_private_key_file=/etc/pki/simp_apps/vsftpd/pki/private/foo.example.com.pem
ca_certs_file=/etc/pki/simp_apps/vsftpd/pki/cacerts/cacerts.pem
validate_cert=YES
